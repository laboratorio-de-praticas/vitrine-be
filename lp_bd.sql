...
VALUES
(1, NOW(), NOW(), 'Ativo', 'http://18.212.16.5:3000/votacao/interna/confirmacao/1/1', 1, 1),
(2, NOW(), NOW(), 'Ativo', 'http://18.212.16.5:3000/votacao/interna/confirmacao/2/1', 1, 2),
(3, NOW(), NOW(), 'Ativo', 'http://18.212.16.5:3000/votacao/interna/confirmacao/3/1', 1, 3),
(4, NOW(), NOW(), 'Ativo', 'http://18.212.16.5:3000/votacao/interna/confirmacao/4/1', 1, 4);

INSERT INTO "Projeto" (id_projeto, fk_id_aluno, titulo, descricao, qrcode, foto_url) VALUES 
(1, 2, 'Tagarela', 'Projeto para auxílio de crianças com espectro autista.', 'http://18.212.16.5:3000/votacao/publica/confirmacao/avaliador/classificacao/id_projeto/id_evento/1/1', './sunside.png'),
(2, 1,'EcoVision', 'Projeto para auxílio nos cuidados de plantas ornamentais.', 'http://18.212.16.5:3000/votacao/publica/confirmacao/convidado/id_projeto/id_evento/2/1', './ecovision.png');
